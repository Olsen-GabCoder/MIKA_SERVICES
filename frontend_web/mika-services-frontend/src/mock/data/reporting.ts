...
export const mockGlobalDashboard: GlobalDashboard = {
  ...
  budget: {
    ...
    ecart: -162_500_000,
    tauxConsommation: 64,
    montantTotalMarches: 450_000_000,
    montantMarchesEnCours: 300_000_000,
    caPrevisionnelCumule: 450_000_000,
    caRealiseCumule: 287_500_000,
    tauxRealisation: 63.9,
    evolutionMensuelle: [],
  },
  planning: {
    tachesTotal: 86,
...
export const mockProjetReport1: ProjetReport = {
  ...
  budget: {
    ...
    ecart: -42_000_000,
    tauxConsommation: 65,
    montantTotalMarches: 120_000_000,
    montantMarchesEnCours: 120_000_000,
    caPrevisionnelCumule: 120_000_000,
    caRealiseCumule: 78_000_000,
    tauxRealisation: 65,
    evolutionMensuelle: [],
  },
  planning: {
...
export const mockProjetReport2: ProjetReport = {
  ...
  budget: {
    ...
    ecart: -22_500_000,
    tauxConsommation: 74,
    montantTotalMarches: 85_000_000,
    montantMarchesEnCours: 85_000_000,
    caPrevisionnelCumule: 85_000_000,
    caRealiseCumule: 62_500_000,
    tauxRealisation: 73.5,
    evolutionMensuelle: [],
  },
  planning: {
    tachesTotal: 18,
