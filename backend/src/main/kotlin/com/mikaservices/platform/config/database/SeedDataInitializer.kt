...
class SeedDataInitializer(
    ...
    private fun ensureProjetId1() {
        ...
        jdbcTemplate.update("""
            ...
            VALUES (1, 'N°148/MTP/SG/2024', 'N°148/MTP/SG/2024', 'Projet de test (démo)', 'Projet créé automatiquement en environnement de développement.', 'AMENAGEMENT', 'EN_COURS_EXECUTION', 1, NOW(), NOW())
        """.trimIndent())
    ...
    private fun initSuiviMensuel() {
        ...
        val projets = projetRepository.findByActifTrue(PageRequest.of(0, 500)).content
            .filter { it.statut == StatutProjet.EN_COURS_EXECUTION && it.dateDebut != null && it.dateFin != null }
            .take(2)
        if (projets.isEmpty()) return
