...
import type { SuiviEnvResponse, DechetResponse, EnvironnementSummaryResponse, SuiviEnvCreateRequest, DechetCreateRequest } from '@/types/qsheEnvironnement'
import { TypeMesureEnvironnementale, TypeDechet } from '@/types/qsheEnvironnement'
